<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <!-- Tombol Tambah File Tips Kesehatan -->
                <div class="mb-4">
                        ...
                        <tbody>
                            ...
                            <tr class="border-t hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm text-gray-900">
                                    ...
                                    <form id="delete-form-{{ $item->id }}"
                                        action="{{ route('dashboard.prof-kesehatan.destroy', $item->id) }}"
                            ...
                            <tr class="border-t">
                                <td colspan="3" class="px-4 py-3 text-center text-gray-500">
                                    Tidak ada file Tips Kesehatan tersedia.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
    ...
    <!-- Modal Tambah File Tips Kesehatan -->
    <div id="add-file-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
            ...
            <form action="{{ route('dashboard.prof-kesehatan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Input Nama -->
                <div class="mb-4">
